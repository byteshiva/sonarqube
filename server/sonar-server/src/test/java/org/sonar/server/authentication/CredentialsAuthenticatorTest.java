...
public class CredentialsAuthenticatorTest {
  ...
  CredentialsAuthenticator underTest = new CredentialsAuthenticator(dbClient, externalAuthenticator, jwtHttpHandler);
  ...
  public void authenticate_none_local_user() throws Exception {
    ...
    verify(externalAuthenticator).authenticate(LOGIN, PASSWORD, request, response);
  }
  ...
  private void executeAuthenticate(){
    underTest.authenticate(LOGIN, PASSWORD, request, response);
  }
