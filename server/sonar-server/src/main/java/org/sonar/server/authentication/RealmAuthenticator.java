...
public class RealmAuthenticator implements Startable {
  ...
  public void authenticate(String userLogin, String userPassword, HttpServletRequest request, HttpServletResponse response) {
    failIfNoRealm();
    doAuthenticate(getLogin(userLogin), userPassword, request, response);
  }

  private void doAuthenticate(String userLogin, String userPassword, HttpServletRequest request, HttpServletResponse response) {
    ...
    synchronize(userLogin, details, request, response);
  }

  private void synchronize(String userLogin, UserDetails details, HttpServletRequest request, HttpServletResponse response) {
    ...
    userIdentityAuthenticator.authenticate(userIdentityBuilder.build(), new ExternalIdentityProvider(), response);
  }
